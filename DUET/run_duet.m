...
[TwoChannel,fs,nbits] = wavread('data/Animalism.wav');
x1 = TwoChannel(:,1);
x2 = TwoChannel(:,2);

% [x1Old,fsOld,nbitsOld] = wavread('data/x1_reverb.wav');
% x2Old = wavread('data/x2_reverb.wav');
...
freq=[(1:numfreq/2) ((-numfreq/2)+1:-1)]*(2*pi/(numfreq)); % freq looks like raw signal
